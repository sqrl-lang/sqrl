 ...
 */
import { RedisSingleWindowApproxCountService } from "../../src/services/RedisApproxCount";
import { RedisInterface } from "../../src/services/RedisService";
import { RedisUniqueIdService } from "../../src/services/RedisUniqueId";
import SqrlNode from "../../src/object/SqrlNode";
import { buildKey40 } from "../../src/function/KeyFunctions";
import { buildTestTrace } from "../helpers/sqrlTest";
import SqrlUniqueId from "../../src/object/SqrlUniqueId";
...
redisTest("works", async (redis: RedisInterface) => {
  ...
  async function getKeyForIp(ip) {
    ...
    const key = await buildKey40(ctx, nodeId);
