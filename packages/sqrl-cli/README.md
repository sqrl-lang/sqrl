...
This includes a command line application for executing SQRL.

It can be installed globally, or used as a base for extending the standard command line application with your own functionality and SQRL functions.
